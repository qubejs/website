---
title: Qubejs CLI
description: The CLI to scaffold your Qubejs project, features and schemas
---

import { Aside, Tabs, TabItem, Badge } from '@astrojs/starlight/components'
import { PubBadge } from '@/components/PubBadge'

The Qubejs CLI is a new tool that allows you to quickly scaffold projects,
features, schemas and content-items for the Qubejs framework. It is built on top
...
The Qubejs CLI internally uses `pnpm` and `melos` to manage the packages for the
...
The Qubejs CLI needs some additional programs to be installed for it to work
...
In the folder where you plan to build your _mono-repo_ project for the Qubejs
...
A Qubejs Flutter project created by Qubejs CLI.

Usage: vyuh create project <project-name> [arguments]
-h, --help                Print this usage information.
-o, --output-directory    The desired output directory when creating a new project.
    --description         The description for this new project.
                          (defaults to "A Qubejs Flutter project created by Qubejs CLI.")
...
Create a new Qubejs feature CMS schema.
...
within your Qubejs project. Content items represent individual pieces of content,
such as articles, blog posts, or product descriptions.

```text title="Create Item" {3}
Create a new Qubejs ContentItem.
...
properly set up for Qubejs development. It checks for all required dependencies
and their versions:
...
The Qubejs CLI has an inbuilt mechanism to update itself. You can run the

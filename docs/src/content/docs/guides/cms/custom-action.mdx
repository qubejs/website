...
<Image
  ...
  alt="All the System actions available in Qubejs"
  width={[350]}
/>

It is worth mentioning that before you start creating your own action, it is a
good idea to check the ones already available out-of-the-box in Qubejs. These
include:
...
export const misc = new FeatureDescriptor({
  ...
  title: 'Miscellaneous',
  description:
    'The Miscellaneous feature contains a variety of custom content types, conditions, actions, layouts to demonstrate the capabilities of the Qubejs Framework.',
  actions: [showBarcode],
...
**`ActionConfiguration`** class, which is an abstract class built into the Qubejs
...
final feature = FeatureDescriptor(
  ...
  title: 'Misc',
  description:
      'Miscellaneous feature showing all capabilities of the Qubejs Framework.',
...
<Aside>
  ...
  only encode numbers, so it will fail for our string "Qubejs Framework" :hushed:.
</Aside>

...
description:
  Use Widgetbook to preview and test your Qubejs content types in isolation
---

import { Tabs, TabItem } from '@astrojs/starlight/components'

[Widgetbook](https://pub.dev/packages/widgetbook) is a powerful tool for
developing Flutter widgets in isolation. Qubejs provides first-class integration
...
To use Widgetbook in your own Qubejs app:

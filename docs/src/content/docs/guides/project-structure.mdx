...
The Qubejs Framework was designed to build large scale apps in a modular fashion.
...
<Aside>
  ...
  [**Qubejs CLI**](/intro/cli) for creating a new Qubejs App.
</Aside>
...
organization of the files and folders of a typical Qubejs Project.

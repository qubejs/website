...
apps should be put together. The **Qubejs Framework** takes a holistic view of
...
![The Qubejs Framework](../../../assets/logo.svg)
...
The Qubejs Framework is one such super-power that can change the way Apps are

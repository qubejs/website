...
Plugins tackle the cross-cutting capabilities of your application. Qubejs provides
...
| **Navigation**           | Allows navigation and routing to various routes in your application. Qubejs uses the GoRouter is its built-in router.           |
| **Analytics**            | Tracks all events, actions, network calls, navigation inside your Qubejs App                                                    |

---
title: Qubejs Plugin Content Provider Sanity
description:
  A Content Provider for the Sanity.io CMS. It fetches documents and App
  configurations via the Sanity Client and renders them with Qubejs
---
...
[Sanity.io](https://sanity.io) is the default CMS that is used by the Qubejs
framework. This provider allows you to fetch documents from a Sanity dataset
using GROQ queries and render them using the Qubejs framework.

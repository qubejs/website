...
This is a system level feature that is needed for all Qubejs Apps. It includes the
...
This is one of the most versatile content blocks in Qubejs. A card has a `title`,
...
- **Refresh a Route**
- **Restart the Qubejs Application**

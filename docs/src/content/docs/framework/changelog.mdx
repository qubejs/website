...
- Introduced **Events** for communicating between Features and Plugins. Events
  ...
  payloads.
- Complete refresh of the https://qubejs.com **Website** which is now built with
  Astro
...
- Launched **1.0** with foundation capabilities that are required by all
  CMS-driven and Modular Qubejs Apps
- **Core API** to run a Qubejs App using modular Features and Plugins
...
- **Developer Tool** to give an X-Ray view of your Qubejs App
- **Navigation** is done via **GoRouter** including full support for dynamic
  routes loaded at runtime and templated routes.
- **Qubejs CLI** to quickly scaffold your Qubejs App, Feature package and a Sanity
  schema package
